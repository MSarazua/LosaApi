...
using LosaCrud.Models;

namespace LosaCrud.Controllers
{
    public class ProductosController : ApiController
    {
        ...
        public IHttpActionResult PostProductos(Productos productos)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = productos.pro_codigo }, productos);
        }
        ...
        {
            return db.Productos.Count(e => e.pro_codigo == id) > 0;
        }
    }
}